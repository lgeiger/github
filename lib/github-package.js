  ...
  async activate(state = {}) {
    ...
    this.subscriptions.add(
      ...
      atom.workspace.observeTextEditors(editor => {
        ...
        new GitDiffView(editor, this.getActiveRepository.bind(this)); // eslint-disable-line no-new

        this.watchedEditors.add(editor);
        // This subscription wasn't disposed in git-diff though I think we should handle this.
        editor.onDidDestroy(() => this.watchedEditors.delete(editor));
      }),
    );
